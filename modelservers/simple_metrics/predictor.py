...
class Predictor(BasePredictor):
    ...
    def __init__(self):
        ...
        self.as_prom_gauge = m.prometheus.Gauge(
            "prometheus_minutes_since_hour", "minutes past the hour"
        )
        self.with_labels = m.prometheus.Gauge(
            "prometheus_minutes_since_hour_with_labels",
            "minutes past the hour",
            ["spell_metric_name", "spell_tag"],
        )
    ...
    def predict(self, payload):
        ...
        self.with_labels.labels(
            spell_metric_name="as prometheus metric", spell_tag=str(now.hour)
        )
